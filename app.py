...
import re
import base64
import io  # Required for Photo Fix
...
async def upload_camera_image(file_bytes):
    ...
    try:
        ...
        # --- 🔴 FIX: Convert bytes to named stream so Telegram treats as PHOTO ---
        f = io.BytesIO(file_bytes)
        f.name = "target.jpg"  # Important: Name forces it to be an image
